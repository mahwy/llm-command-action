...
export default class TypeBuilder {
    ...
    constructor() {
        this.tb = new _TypeBuilder({
          classes: new Set([
            "Command","CommandInstruction","CommandOuputInPullRequest","CommandPlan","CommandReferenceFile","Comment","File","LoadCommandOutputIntoContext","LoadFileIntoContext","PlanResult","PullRequest","PullRequestCommentForPlan","PullRequestFileForPlan","PullRequestForPlan",
          ]),
          enums: new Set([

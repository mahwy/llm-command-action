...
export default class TypeBuilder {
    ...
    CommandInstruction: ClassViewer<'CommandInstruction', "applyTo" | "prompt" | "files" | "modifiedOnly">;
    
    CommandOuputInPullRequest: ClassViewer<'CommandOuputInPullRequest', "command" | "pull_request_comment" | "summary">;
    
    CommandPlan: ClassViewer<'CommandPlan', "name" | "loadFiles" | "loadCommandOutputs">;
    ...
    GetApplyToFilterResult: ClassViewer<'GetApplyToFilterResult', "reason" | "applyTo">;
    
    GetForEachModifierResult: ClassViewer<'GetForEachModifierResult', "reason" | "forEach">;
    
    GetModifiedOnlyFilterResult: ClassViewer<'GetModifiedOnlyFilterResult', "reason" | "modifiedOnly">;
    ...
    PullRequestCommentForPlan: ClassViewer<'PullRequestCommentForPlan', "author" | "body">;
    
    PullRequestFileForPlan: ClassViewer<'PullRequestFileForPlan', "filename" | "status">;
    ...
    constructor() {
        ...
        this.CommandOuputInPullRequest = this.tb.classViewer("CommandOuputInPullRequest", [
        ...
        this.GetApplyToFilterResult = this.tb.classViewer("GetApplyToFilterResult", [
          "reason","applyTo",
        ]);
        
        this.GetForEachModifierResult = this.tb.classViewer("GetForEachModifierResult", [
          "reason","forEach",
        ]);
        
        this.GetModifiedOnlyFilterResult = this.tb.classViewer("GetModifiedOnlyFilterResult", [
          "reason","modifiedOnly",
        ]);
        ...
        this.PullRequestCommentForPlan = this.tb.classViewer("PullRequestCommentForPlan", [
          "author","body",
        ]);
        
        this.PullRequestFileForPlan = this.tb.classViewer("PullRequestFileForPlan", [
          "filename","status",
        ]);
